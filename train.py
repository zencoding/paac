...
def get_arg_parser():
    ...
    parser.add_argument('-lra', '--lr_annealing_steps', default=80000, type=int, help="Nr. of global steps during which the learning rate will be linearly annealed towards zero", dest="lr_annealing_steps")
    ...
    parser.add_argument('--max_global_steps', default=80000, type=int, help="Max. number of training steps", dest="max_global_steps")
